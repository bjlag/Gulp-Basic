...
Для тестирвоания используется фреймворк PHPUnit.
Тесты пишутся в папке _/tests/backend_.
Конфигурация _phpunit.xml_.
Bootstrap _/vendor/autoload.php_.

### Front-end

Для тестирвоания используется фреймворк Mocha.
Тесты пишутся в папке _/tests/frontend_.
Настройка окружения тестирования в _karma.conf.js_.
